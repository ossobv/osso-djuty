...
class PaymentAlreadyUsed(BuyerError):
    """
    This payment has been used already. User has gone back to a payment
    page where he should not be.
    """
    pass
...
class TryDifferentPayment(BuyerError):
    """
    Provider says you have no money or chose the wrong payment method.
    """
    pass
